...
public class UserResponse {
    ...
    public UserResponse(Long id, String fullName, String email, String studentId,
                        User.Role role, Integer penaltyPoints, LocalDateTime createdAt) {
        this.id = id;
    ...
    public static UserResponse from(User user) {
        return new UserResponse(
                ...
                user.getStudentId(), user.getRole(),
